...
function isPathToPackageFile(path) {
    for (var _i = 0, DETECTABLE_FILES_1 = DETECTABLE_FILES; _i < DETECTABLE_FILES_1.length; _i++) {
        var fileName = DETECTABLE_FILES_1[_i];
...
function detectPackageManager(root, options) {
    ...
    if (!packageManager) {
        throw new Error('Could not detect supported target files in ' + root +
            ...
            'target files: ' +
            chalk_1.default.underline('https://support.snyk.io/getting-started/languages-support') +
...
function detectPackageFile(root) {
    for (var _i = 0, DETECTABLE_FILES_2 = DETECTABLE_FILES; _i < DETECTABLE_FILES_2.length; _i++) {
        var file = DETECTABLE_FILES_2[_i];
