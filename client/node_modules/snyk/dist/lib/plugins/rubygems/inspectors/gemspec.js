...
var try_get_spec_1 = require("./try-get-spec");
var pattern = /\.gemspec$/;
...
function gatherSpecs(root, target) {
    return __awaiter(this, void 0, void 0, function () {
        var targetName, targetDir, files, gemspec, gemfileLock, gemfile;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    files = {};
                    return [4 /*yield*/, try_get_spec_1.tryGetSpec(root, path.join(targetDir, targetName))];
                case 1:
                    gemspec = _a.sent();
                    if (gemspec) {
                    ...
                    return [4 /*yield*/, try_get_spec_1.tryGetSpec(root, path.join(targetDir, 'Gemfile.lock'))];
                case 2:
                    gemfileLock = _a.sent();
                    if (gemfileLock) {
                        files.gemfileLock = gemfileLock;
                    }
                    return [4 /*yield*/, try_get_spec_1.tryGetSpec(root, path.join(targetDir, 'Gemfile'))];
                case 3:
                    gemfile = _a.sent();
                    if (gemfile) {
